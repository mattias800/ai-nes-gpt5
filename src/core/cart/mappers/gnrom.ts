...
// GNROM / GxROM (Mapper 66)
// - Single register at $8000-$FFFF with PRG and CHR bank bits.
//   Common variant: PRG bank = (value >> 4) & 0x03 (32KB), CHR bank = value & 0x03 (8KB)
export class GNROM implements Mapper {
  private prg: Uint8Array;
  private chr: Uint8Array;
  private reg = 0; // last written value
